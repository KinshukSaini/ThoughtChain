...
const TreeFlow = () => {
  ...
  useEffect(() => { if (!nodes.length) { const r = addNode("Root"); setCurrNode(r); } }, []); // eslint-disable-line
  ...
  return (
    <div style={{ width: "100%", height: "100vh", position: "relative" }}>
      <ReactFlow nodes={nodes} edges={edges} onNodesChange={onNodesChange} onEdgesChange={onEdgesChange} onConnect={onConnect}
        onInit={(i) => { rf.current = i; }} onNodeClick={(_, n) => setCurrNode(Number(n.id))} style={{ width: "100%", height: "100%" }}>
        <Background />
      </ReactFlow>
